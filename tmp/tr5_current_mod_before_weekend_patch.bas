...
Private Sub TrimTimelineToRange(ByVal ws As Worksheet, ByVal firstD As Date, ByVal lastD As Date)
    On Error GoTo EH
...
Private Sub FixHeaderMerges(ByVal ws As Worksheet, ByVal endCol As Long)
    ...
    subtitleFormula = ws.Cells(2, titleStartCol).Formula
    If Len(CStr(subtitleFormula)) = 0 Then subtitleFormula = ws.Cells(2, 1).Formula
...
Private Function RiskBarColorLong(ByVal risk As String, ByVal phase As String) As Long
